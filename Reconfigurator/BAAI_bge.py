...
with open("Reconfigurator/RagData/vulnsDB_cleaned.json", "r", encoding="utf-8") as f:
    vulns = json.load(f)
...
np.save("Reconfigurator/RagData/vulns_cleaned_embeddings_bge_m3.npy", embeddings)
